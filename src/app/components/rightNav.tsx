export default function RNAV(props:any) {
    ...
    return (
    <>
<div className="fixed right-0 top-[74px] bottom-[91px]  w-[87px] ">
    <div className="w-full h-full bg-wppdark border-t-[1.5px] border-b-[1.5px] border-black flex flex-col justify-between p-3 gap-y-2">
